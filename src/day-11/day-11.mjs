...
class Day11 extends Problem {
  ...
  solvePart1() {
    ...
    for (let i = 0; i < number_of_monkeys; i++) {
      ...
      const [_starting_item_key, starting_item_value] = start_item_string.split(": ")
      const [_operation_key, operation_value] = operation_string.split("old ")
      const [_test_key, test_value] = test_string.split("by ")
      const [_true_monkey_key, true_monkey_value] = true_monkey_string.split("monkey ")
      const [_false_monkey_key, false_monkey_value] = false_monkey_string.split("monkey ")
      ...
      const operation = (worry_level) => {
        ...
        throw new Error("You shouldn't have gotten to this point, what's wrong with you?!")
      }
      ...
      const monkey = new Monkey(starting_items, operation, test, true_monkey, false_monkey, monkey_collection)
